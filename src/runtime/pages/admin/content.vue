        ...
        <table class="w-full text-left border-collapse">
          <thead>
            <tr class="bg-slate-50 border-b border-slate-100">
              <th class="py-4 px-6 font-semibold text-slate-600">
                Title
              </th>
              <th class="py-4 px-6 font-semibold text-slate-600">
                Type
              ...
              <th class="py-4 px-6 font-semibold text-slate-600 text-right">
                Actions
              </th>
            </tr>
          </thead>
          <tbody>
            ...
            <tr
              ...
              :key="item.id"
              class="border-b border-slate-50 last:border-none hover:bg-slate-50/50 transition-colors"
            >
              <td class="py-4 px-6">
              ...
              <td class="py-4 px-6 capitalize text-slate-600">
                {{ item.content_type }}
              </td>
              <td class="py-4 px-6">
                <span
